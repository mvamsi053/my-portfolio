            ...
            <div className="flex w-full mobile:flex-col  mobile:justify-center items-start gap-x-4 mobile:gap-y-4" >
             ...
             <div className="flex flex-col w-full">
                ...
                <ul className="skills-list flex flex-col justify-center items-start text-slate  list-outside leading-8  pl-2 " >
                       <li className="para-md" >Working with <span className="text-primary1">ReactJs ,NextJs Tailwind CSS, React Query </span>  etc,</li>
                    <li className="para-md" >Developed <span className="text-primary1" >SEO friendly</span>  company website with correct
                        technology process,industry best practices and company
                     standards . </li>
                 
                    <li className="para-md" >Assisted the development team in developing <span className="text-primary1">5+  </span> web
                      applications.</li>
