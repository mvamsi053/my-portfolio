...
export default function About()
{
    ...
    return<section className="min-h-[90vh] mobile:h-[100vh] h-full relative z-10 flex flex-col items-center justify-start w-[80%] mobile:w-[90%]"  id="about" >
        ...
        <div className="flex w-full h-full items-start justify-between mobile:flex-col"> 
            ...
            <div className="w-[30%] h-full relative mobile:w-[60%] mobile:self-center mobile:mt-4 " >
                ...
                <Image src="/assets/images/vmc2.png" atl="profile picture" height={1524} width={1200} className="w-full h-auto object-contain aspect-square mix-blend-multiply hover:mix-blend-normal" />

                </div>
                <div className={`absolute w-[100%]   border border-primary1 rounded-lg z-0 aspect-square ${isHover?"translate-x-4 translate-y-7 ":"translate-x-6 translate-y-9"} transition ease-in-out duration-300 `} >
