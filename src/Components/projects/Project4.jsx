...
export default function Project4(){
    return<div className="flex flex-row-reverse relative w-full h-[60vh]  items-center" >
        ...
        <div className="flex  relative h-[75%] flex-col w-[50%] items-start justify-center " >
            ...
            <motion.a href="https://github.com/mvamsi053/Nala_bheema_Paakam" target="_blank" className="w-[1.5rem] overflow-hidden  block" whileHover={{ scale: 1.1 }}  >
            ...
            <motion.a href="https://nala-bheema-paakam.netlify.app" whileHover={{scale:1.1}} target="_blank" className="w-[1.5rem] h-[1.5rem] block overflow-hidden self-start">
