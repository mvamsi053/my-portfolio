...
export default function Project5({ myRef }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex  relative h-[75%] mobile:bg-navy/80 mobile:rounded-md mobile:h-[80%] mobile:w-full flex-col w-[50%] items-end justify-center ">
        <div className="top-0 absolute text-right mobile:static mobile:pr-4 ">
        ...
        <div className="bg-navy absolute w-[120%] mobile:static mobile:w-full  z-10">
          <ul className="text-right p-6 mobile:pr-4 text-slatelite rounded-xl w-full h-full shadow-two leading-[1.8rem]">
            <li className="para-nml">
              ...
              <span className="text-primary1">ReactJs</span> ,{" "}
            </li>
            <li className="para-nml">
              Used <span className="text-primary1">Contex Api</span> ,{" "}
              <span className="text-primary1">useReducer</span> hooks to achieve
              functionalities ,
            </li>
            <li className="para-nml">
              Used <span className="text-primary1">Bootstrap </span> for styling
              .
            </li>
          </ul>
        </div>
        <div className="absolute bottom-2 mobile:static mobile:pr-4 flex flex-col items-end gap-y-2">
          ...
          <div className="w-full justify-end flex gap-x-3">
            <motion.a
              href="https://react-shopping-cart-vamsim.netlify.app"
            ...
            <motion.a
              href="https://github.com/mvamsi053/ReactJs_shopping_cart"
              target="_blank"
