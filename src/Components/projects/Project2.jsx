        ...
        <div className="flex  relative h-[75%] flex-col w-[50%] items-start justify-center " >
            ...
            <div className="bg-navy absolute w-[120%]  z-10">
                <ul className="text-left p-6 text-slatelite rounded-xl  shadow-two leading-[1.8rem]">
                    ...
                    <li className="para-nml" > Partnered with designers and back-end team in development,</li>
            ...
            <motion.a href="https://collaborate.aptagrim.com/" whileHover={{scale:1.1}} target="_blank" className="w-[1.5rem] h-[1.5rem] block overflow-hidden self-start">
