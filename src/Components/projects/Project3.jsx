...
export default function Project3({ myRef }) {
    ...
    >
      ...
      <div className="flex  relative h-[75%] flex-col w-[50%] mobile:bg-navy/80 mobile:rounded-md mobile:h-[80%]  mobile:w-full items-end justify-center ">
        ...
        <div className="bg-navy mobile:static absolute w-[120%] mobile:w-full z-10">
          <ul className="text-right p-6 mobile:pr-4 text-slatelite rounded-xl w-full h-full shadow-two leading-[1.8rem]">
            <li className="para-nml">
              Complete <span className="text-primary1">MERN</span> Stack
              application with Authentication and Autharization ,
            </li>
            <li className="para-nml">
              Integrated <span className="text-primary1">MapTiler</span> api for
              maps and <span className="text-primary1">multer</span> for file
              upload,
            </li>

            <li className="para-nml">
              {" "}
              Used <span className="text-primary1">custom hooks</span> for api
              requests.{" "}
            </li>
          </ul>
        </div>
        <div className="absolute mobile:static mobile:pr-4 bottom-2  flex flex-col items-end gap-y-2">
          ...
          <motion.a
            href="https://github.com/mvamsi053/social-media-app"
            target="_blank"
